	...
	\begin{center}
		\begin{tabular}{| c | c | c |}
			...
			{\bf freshness} &  $\believes{A}{\fresh{n_A}}$ & $\believes{B}{\fresh{n_B}}$\\
			              \ &  $\believes{A}{\fresh{L_A}}$ & $\believes{A}{\fresh{L_A}}$\\
			              \ &  $\believes{A}{\fresh{L_B}}$ & $\believes{A}{\fresh{L_B}}$\\
			\hline
		\end{tabular}
	\end{center}
\section{Analisi dei \emph{beliefs}}
	...
	\subsection{Messaggio $M1$}
		...
		\[
			\frac{\believes{B}{\publickeyowner{\publickey{T}}{T}},\ \sees{B}{\encrypt{\publickeyowner{\publickey{A}}{A}}{\privatekey{T}}}}
			{\believes{B}{\said{T}{\publickeyowner{\publickey{A}}{A}}}}
		\]
		e poiché
		\[
		...
		\[
			\frac{\believes{B}{\said{T}{\publickeyowner{\publickey{A}}{A}}},\ \believes{B}{\fresh{\publickeyowner{\publickey{A}}{A}}}}
